...
public class ChiseledLootTableGen extends FabricBlockLootTableProvider {
    public ChiseledLootTableGen(FabricDataOutput dataOutput, CompletableFuture<HolderLookup.Provider> registryLookup) {
    ...
    public void generate() {
        ...
        dropSelf(ChiseledBlocks.MOSSY_POLISHED_STONE);
        dropSelf(ChiseledBlocks.MOSSY_POLISHED_STONE_STAIRS);
        add(ChiseledBlocks.MOSSY_POLISHED_STONE_SLAB, createSlabItemTable(ChiseledBlocks.MOSSY_POLISHED_STONE_SLAB));
        dropSelf(ChiseledBlocks.MOSSY_POLISHED_STONE_WALL);
